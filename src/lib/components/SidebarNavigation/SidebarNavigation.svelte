<script lang="ts">
	import HomeIcon from '$lib/assets/icons/home.svg?component';
	import SpeakIcon from '$lib/assets/icons/speak.svg?component';
	import EyeIcon from '$lib/assets/icons/eye.svg?component';
